...
ALTER TABLE `courses` ADD FOREIGN KEY (`rID`) REFERENCES `rooms`(`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `courses` ADD FOREIGN KEY (`iID`) REFERENCES `instructors`(`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
